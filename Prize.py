...
if options == "Introduction":
    ...
    with col2:
        st.markdown("""
        <p><img style="float: right;margin:0.5px 20px 10px 20px; max-width: 200px;height: 220px;display: inline-block" src="https://www.nicepng.com/png/detail/11-111010_laurel-wreath-psd37402-laurel-wreath.png"></p>""",unsafe_allow_html=True)


    st.markdown("--------")

    st.title("Brief History of Nobel Prize")
    st.video("https://www.youtube.com/watch?v=rXhpK_lhonA&ab_channel=TED-Ed")
...
if options == "By Category":
    ...
    with col7:
        ...
        if 'Chemistry' in grouped['category'].unique():
            st.write(f"""
                <div>
                    ...
                    <div style="display:inline-block;vertical-align:center;font-size:50px;padding-left: 30px;margin-left:1em";>
                    {grouped[grouped['category']=='Chemistry']['size'].values[0]}
        ...
        if 'Physics' in grouped['category'].unique():
            st.write(f"""
                <div>
                    <div style="display:inline-block;vertical-align:center;">
                    ...
                    {grouped[grouped['category']=='Physics']['size'].values[0]}
                    </div>
                    """,unsafe_allow_html=True)
        else:
            st.write(f"""
        ...
        if 'Medicine' in grouped['category'].unique():
            st.write(f"""
                    <div>
                        <div style="display:inline-block;vertical-align:center;">
                        ...
                        {grouped[grouped['category']=='Medicine']['size'].values[0]}
                        </div>
                        """,unsafe_allow_html=True)
        else:
            st.write(f"""
    ...
    with col8:
            ...
            if 'Peace' in grouped['category'].unique():
                st.write(f"""
                        <div>
                            <div style="display:inline-block;vertical-align:center;">
                            ...
                            <div style="display:inline-block;vertical-align:center;font-size:50px;padding-left: 30px;margin-left:2.1em";>
                            {grouped[grouped['category']=='Peace']['size'].values[0]}
                            </div>
                            """,unsafe_allow_html=True)
            else:
                st.write(f"""
            ...
            if 'Literature' in grouped['category'].unique():
                st.write(f"""
                        <div>
                            <div style="display:inline-block;vertical-align:center;">
                            ...
                            {grouped[grouped['category']=='Literature']['size'].values[0]}
                            </div>
                            """,unsafe_allow_html=True)
            else:
                st.write(f"""
            ...
            if 'Economics' in grouped['category'].unique():
                st.write(f"""
                        <div>
                            <div style="display:inline-block;vertical-align:center;">
                            ...
                            {grouped[grouped['category']=='Economics']['size'].values[0]}
                            </div>
                            """,unsafe_allow_html=True)
            else:
                st.write(f"""
...
if options == "By Age and Gender":
    ...
    with col13:
            st.subheader("Youngest Nobel Laureate")

            st.write("""
            <div class="img-with-text">
                <img src="https://www.apple.com/newsroom/images/product/apple-tv-plus/standard/Apple_Nobel-laureate-Malala-Yousafzai-to-bring-empowering-programming-to-Apple-TVPlus_030821_big.jpg.large.jpg" alt="sometext" height = 400 width=500 />
                <p>Malala Yousafzai
            ...
            Prize motivation: "for their struggle against the suppression of children and

            young people and for the right of all children to education."</p>
                        </div>""",unsafe_allow_html=True)

    with col14:
            st.subheader("Oldest Nobel Laureate")

            st.write("""
                    <div class="img-with-text">
                        <img src="https://nationalmedals.org/wp-content/uploads/2020/07/Leonid-Hurwicz-1.jpg" alt="sometext" height = 400 width=500 />
                        <p> Leonid Hurwicz
